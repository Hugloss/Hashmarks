...
- `dependency_resolution_contract.py` — owns the v3 schema identity, semantic-authority vocabulary, and fail-closed field allowlists; it contains no qualification or query behavior.
