...
def test_verification_plan_derives_pytest_argv_without_shell_guess(tmp_path: Path) -> None:
    ...
    assert plan["argv"] == ["python", "-m", "pytest", "-q", "tests/test_widget.py::test_widget"]
