...
offline with uv 0.10.0 in the experimental corpus. The `absent` lock was
resolved offline with uv 0.12.17. Each state includes its source project files.
...
Run `make dependency-dogfood` for the six named add/version-change/remove
