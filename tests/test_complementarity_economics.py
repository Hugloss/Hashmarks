...
def test_pytest_more_specific_selector_satisfies_file_authority() -> None:
    ...
    assert verification_surface(candidate) == {
        "runner": "pytest", "surface": "tests/test_widget.py", "selector": "test_widget"
    }
...
def test_complementarity_summary_requires_preserved_success_and_lower_cost() -> None:
    native = summarize_complementarity_lane("native", [
        {"verified_solution": True, "decision_visible_bytes": 1000, "repository_evidence_bytes": 1000, "decision_interactions": 4, "search_calls": 1, "read_calls": 2},
        {"verified_solution": True, "decision_visible_bytes": 800, "repository_evidence_bytes": 800, "decision_interactions": 3, "search_calls": 1, "read_calls": 1},
    ])
    assisted = summarize_complementarity_lane("hashmarks", [
        {"verified_solution": True, "decision_visible_bytes": 500, "repository_evidence_bytes": 100, "decision_interactions": 2, "search_calls": 0, "read_calls": 1},
        {"verified_solution": True, "decision_visible_bytes": 500, "repository_evidence_bytes": 100, "decision_interactions": 2, "search_calls": 0, "read_calls": 1},
    ])
